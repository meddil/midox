...
<!-- FontAwesome CSS-->
	...
	<!-- Theme CSS -->
	<link rel="stylesheet" href="/var/www/wp-content/themes/midox-theme/blog-site-template-master/css/style.css">
...
<body>
    ...
    <div class="main-wrapper">
	    <header class="page-title theme-bg-light text-center gradient py-5">
			<h1 class="heading">wafiin al3awd</h1>
		</header>
		<article class="content px-3 py-5 p-md-5">
	    <div class='container'>
			<p class="mt-3 lead">hhhhhum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. </p>
